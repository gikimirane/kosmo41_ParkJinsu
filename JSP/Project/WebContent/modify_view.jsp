...
<table class="table">
	<form name="write_form" action="modify.do" method="post">
		...
		<tr>
			<div class="container">
				<div class="input-group mb-3">
	  				<input type="text" class="form-control" name="bTitle" placeholder="제목" value="${content_view.bTitle}"aria-label="Recipient's username" aria-describedby="basic-addon2">
				</div>
			</div>
		</tr>
		<tr>
