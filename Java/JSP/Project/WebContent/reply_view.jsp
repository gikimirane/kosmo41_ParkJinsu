...
<table class="table">
	<form name="write_form" action="reply.do" method="post">
		...
		<tr>
			<div class="container">
				<div class="input-group mb-3">
	  				<input type="text" class="form-control" name="bTitle" placeholder="제목" value="${reply_view.bTitle} - " aria-label="Recipient's username" aria-describedby="basic-addon2">
				</div>
			</div>
		</tr>
		<tr>
		...
		<div class="input-group">
	  		<textarea class="form-control" rows="20" name="bContent" id="ir1" aria-label="With textarea">
			${reply_view.bContent}
			</textarea>
